...
namespace PaymentSystem
{
    public class UserListModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            sql += " ((SELECT COALESCE(SUM(Price),0) FROM Payments WHERE Payments.UserId=Users.UserId)-(SELECT COALESCE(SUM(Price),0) FROM Transactions WHERE Transactions.Status=1 AND Transactions.UserId=Users.UserId)) AS Balance FROM Users ";
