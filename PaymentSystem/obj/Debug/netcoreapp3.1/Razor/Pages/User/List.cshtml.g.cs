#pragma checksum "C:\Users\baris\source\repos\PaymentSystem\PaymentSystem\Pages\User\List.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "466216e07445e6389dfd96a690d0ac4783c085df"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"466216e07445e6389dfd96a690d0ac4783c085df", @"/Pages/User/List.cshtml")]
            ...
            columns: [
                ...
                { data: 'Status',render:function (data){if (data==1){return '<div class=\""badge badge-success\""> </div>'}else{return '<div class=\""badge badge-danger\""> </div>' }}},
                {
                    ...
                    render: function (data) {
                        return '<a href=""/Transaction/List?userid=' + data + '"" class=""btn btn-primary btn-sm""><i ");
            WriteLiteral(@"class=""fa fa-credit-card""></i></a><a href=""/Payment/List?userid=' + data + '"" class=""btn btn-primary btn-sm""><i class=""fa fa-money""></i></a><a href=""/User/Edit?id=' + data + '"" class=""btn btn-primary btn-sm""><i class=""fa fa-edit""></i></a>'
